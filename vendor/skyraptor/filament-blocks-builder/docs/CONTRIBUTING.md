# Welcome to the Filament Blocks Builder contributing guide!
...
If you spot a problem with the project, [search if an issue already exists](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments). If a related issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/bumbummen99/filament-blocks-builder/issues/new/choose).

#### Solve an issue

Scan through our [existing issues](https://github.com/bumbummen99/filament-blocks-builder/issues) to find one that interests you. You can narrow down the search using `labels` as filters. See "[Label reference](https://docs.github.com/en/contributing/collaborating-on-github-docs/label-reference)" for more information. As a general rule, we don’t assign issues to anyone. If you find an issue to work on, you are welcome to open a PR with a fix.
...
2. Install or update to the **PHP** version specified in `composer.json`. For more information, see [the development guide](./contributing/development.md).
...
1. In case of an Windows environment WSL2 has to be used as ther project does require bash.
