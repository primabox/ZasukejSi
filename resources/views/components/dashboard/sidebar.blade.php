<div class="flex flex-col w-[211px] gap-[10px]">
    <div class="flex flex-col w-[211px] h-[290px] gap-[10px]">
        ...
        <a href="{{ request()->routeIs('preview.*') ? '#' : route('account.services') }}" class="w-[210px] h-[50px] rounded-[8px] border border-[#E6E6E6] flex items-center px-4 gap-3 font-medium text-[14px] text-[#505050]" style="font-family: 'Poppins', sans-serif;">
            <img src="{{ asset('images/icons/list.svg') }}" class="w-[20px] h-[20px]" alt="List" style="filter: invert(36%) sepia(87%) saturate(2222%) hue-rotate(309deg) brightness(90%) contrast(92%);">
            Moje služby a ceny
        </a>
        <a href="{{ request()->routeIs('preview.*') ? '#' : route('account.statistics') }}" class="w-[210px] h-[50px] rounded-[8px] border border-[#E6E6E6] flex items-center px-4 gap-3 font-medium text-[14px] text-[#505050]" style="font-family: 'Poppins', sans-serif;">
            <img src="{{ asset('images/icons/BarChart4.svg') }}" class="w-[20px] h-[20px]" alt="BarChart" style="filter: invert(36%) sepia(87%) saturate(2222%) hue-rotate(309deg) brightness(90%) contrast(92%);">
            Statistiky
        </a>
